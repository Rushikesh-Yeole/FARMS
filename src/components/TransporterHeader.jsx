        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 z-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="flex flex-col space-y-4">
              <button className="text-white bg-green-700 hover:bg-white hover:text-green-700 border border-green-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">
                Farmer
              </button>
