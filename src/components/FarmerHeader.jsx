          ...
          <div className="relative">
            ...
            {isProfileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-green-700 rounded-md shadow-lg">
                <ul className="py-1">
                  <li>
                    <NavLink to="/fstock" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-700 hover:text-white">My Stock</NavLink>
                  </li>
                  <li>
                    <NavLink to="/spost" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-700 hover:text-white">Post Stock</NavLink>
                  </li>
                  <li>
                    <NavLink to="/fdpost" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-700 hover:text-white">Transport Demand</NavLink>
                  </li>
                  <li>
                    <NavLink to="/fdemand" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-700 hover:text-white">My Transport Demand</NavLink>
                  </li>
                </ul>
              </div>
            )}
