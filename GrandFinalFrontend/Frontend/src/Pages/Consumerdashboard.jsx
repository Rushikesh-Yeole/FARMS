...
// Update order requests data structure
const orderRequests = [
  {
    id: 1,
    crop: "Wheat",
            ...
            {orderRequests.map((order) => (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`px-2 py-1 rounded text-sm ${
                      ...
                      {order.status === 'pending' ? 'Pending' : 'View Farmer Details'}
                    </span>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                  ...
                  <p>Location: {order.location || 'Not specified'}</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {selectedFarmer.message && (
                <p className="text-sm text-green-600">{selectedFarmer.message}</p>
              )}
            </div>
          </motion.div>
        </div>
