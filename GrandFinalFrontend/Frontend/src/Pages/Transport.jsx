...
export default function Transport() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-6">
      ...
      >
        <h2 className="text-2xl font-bold text-green-800 mb-6">Find Transport Routes</h2>
        <div className="flex items-center gap-4">
          ...
          />
          <FaLongArrowAltRight className="text-green-600 text-xl" />
          <input
            type="text"
            placeholder="To"
            value={toInput}
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {cards.length > 0 ? (
          ...
          <p className="text-center text-gray-500 col-span-full">No routes available</p>
        )}
      </div>
      ...
      {selectedCard && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
          <motion.div 
            ...
            className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-xl w-full max-w-5xl p-6 relative"
          >
            <button 
            ...
            <h3 className="text-2xl font-bold text-green-800 mb-6">Transport Details</h3>
